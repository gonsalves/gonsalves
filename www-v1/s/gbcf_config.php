<?php if(@$lock != "on"){echo('<h2>Config Access Not Allowed!</h2>');exit();} ?>
<?php ##########################################################################
// Secure & Accessible PHP Contact Form by Mike Cherim - http://green-beast.com
// Enter any and all needed values as currently formatted and edit nothing else
################################################################################
// FORM AND CONTACT CONFIG PART 1 of 8 - General form configuration   (REQUIRED)
################################################################################


// Enter your email address
    $gb_email_address=        "desk@rahulgonsalves.com"; 

// Enter your name or company
    $gb_contact_name=         "Rahul Gonsalves"; 

// Set site/form possession
    $gb_possession=           "pers";                   // "pers"; or "org";

// Enter website name
    $gb_website_name=         "Rahul Gonsalves.com";
...
/*    $gb_randomq=     "Is fire hot or cold?";
    ...
    $gb_randoma=    "meat"; 
*/      $gb_randomq=    "Spell trams backwards";
      $gb_randoma=    "smart"; 
...
// Enter your error heading
     $error_heading=          "Whoops! There was a problem.!"; 
